...
#find_last_week = dt.datetime(find_last_week.year, find_last_week.month, find_last_week.day)
...
for el in opens.iterrows():
    ...
    if el[1]["Business Unit"] == "TCH Austin":
        ...
        if (el[1]["Pay Grade"] == "11") or (el[1]["Pay Grade"] == 11):
            opens.at[el[0],"Pay Grade"] = "11E"
            tmp_pay_grade = "11E"
            print("Changed data to 11E")
        else:
            tmp_pay_grade = ""
        
        if tmp_pay_grade == "11E":
            opens.at[el[0],"Pay Grade"] = tmp_pay_grade + "Austin"
        else:
    ...
    if (el[1]["WEEKLY_HOURS"] == 40) or (el[1]["WEEKLY_HOURS"] == "40"):
        #print(el[0],"FOUND FULL TIME")
        opens.at[el[0],"FTE"] = "Full Time"
    elif el[1]["PER_DIEM"] == "Yes":
        opens.at[el[0],"FTE"] = "Per Diem"
        print(el[0],"FOUND PD")
    elif "PRN" in el[1]["Requisition Title"]:
...
opens.columns = ['Requisition Number', 'Position Number', 'Job Owner',
       ...
       'Budgeted Start Date', 'Hiring Manager',"Weekly Hours","Per Diem", 'Client Req Number',
       'Account Manager', 'Customer Agreement', 'Project','State/Area',
       'Regional Area', 'Company','Pay Grade',"FTE",'Shift Information1',"Emp ID", 
       'Salary Low', 'Salary High',"Full Name","TCH Name","Coach"]
print("===")
...
receiver_email = ['awhelan@kinetixhr.com','pvelusamy@kinetixhr.com']
#receiver_email = ['awhelan@kinetixhr.com','DART@kinetixhr.com']
